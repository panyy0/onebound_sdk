package cn.onebound.sdk.hardware_industry.jiancaiwang.api;
...
public class JiancaiwangItemApi extends BaseApi {

    public JiancaiwangItemApi(ClientConfig config) {
        super(config, "jiancaiwang");
    }
