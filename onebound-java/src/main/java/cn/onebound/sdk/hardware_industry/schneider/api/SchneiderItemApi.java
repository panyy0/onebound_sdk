package cn.onebound.sdk.hardware_industry.schneider.api;
...
public class SchneiderItemApi extends BaseApi {
    
    public SchneiderItemApi(ClientConfig config) {
        super(config, "schneider");
    }
