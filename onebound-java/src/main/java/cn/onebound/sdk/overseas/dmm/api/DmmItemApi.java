package cn.onebound.sdk.overseas.dmm.api;

import cn.onebound.sdk.core.api.BaseApi;
import cn.onebound.sdk.core.config.ClientConfig;
import cn.onebound.sdk.overseas.dmm.model.response.ItemGetResponse;
import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

public class DmmItemApi extends BaseApi {
    
    public DmmItemApi(ClientConfig config) {
        super(config, "dmm");
    }
