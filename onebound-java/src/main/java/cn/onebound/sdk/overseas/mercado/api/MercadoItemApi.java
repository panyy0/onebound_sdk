package cn.onebound.sdk.overseas.mercado.api;

import cn.onebound.sdk.core.api.BaseApi;
import cn.onebound.sdk.core.config.ClientConfig;
import cn.onebound.sdk.overseas.mercado.model.response.ItemGetResponse;
import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

public class MercadoItemApi extends BaseApi {
    
    public MercadoItemApi(ClientConfig config) {
        super(config, "mercado");
    }
