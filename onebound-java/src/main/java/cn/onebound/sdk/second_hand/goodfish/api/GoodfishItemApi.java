package cn.onebound.sdk.second_hand.goodfish.api;
...
public class GoodfishItemApi extends BaseApi {
    
    public GoodfishItemApi(ClientConfig config) {
        super(config, "goodfish");
    }
