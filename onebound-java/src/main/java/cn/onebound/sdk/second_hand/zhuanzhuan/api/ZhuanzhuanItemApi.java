package cn.onebound.sdk.second_hand.zhuanzhuan.api;
...
public class ZhuanzhuanItemApi extends BaseApi {
    
    public ZhuanzhuanItemApi(ClientConfig config) {
        super(config, "zhuanzhuan");
    }
