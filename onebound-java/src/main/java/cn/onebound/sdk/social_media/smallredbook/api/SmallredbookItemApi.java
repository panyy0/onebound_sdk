package cn.onebound.sdk.social_media.smallredbook.api;
...
public class SmallredbookItemApi extends BaseApi {
    
    public SmallredbookItemApi(ClientConfig config) {
        super(config, "smallredbook");
    }
