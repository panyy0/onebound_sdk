package cn.onebound.sdk.social_media.shortvideo.api;
...
public class ShortvideoItemApi extends BaseApi {

    public ShortvideoItemApi(ClientConfig config) {
        super(config, "shortvideo");
    }
