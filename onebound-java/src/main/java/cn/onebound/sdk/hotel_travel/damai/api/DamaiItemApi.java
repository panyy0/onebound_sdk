package cn.onebound.sdk.hotel_travel.damai.api;
...
public class DamaiItemApi extends BaseApi {
    
    public DamaiItemApi(ClientConfig config) {
        super(config, "damai");
    }
