package cn.onebound.sdk.online_bookstore.dangdang.api;
...
public class DangdangItemApi extends BaseApi {
    
    public DangdangItemApi(ClientConfig config) {
        super(config, "dangdang");
    }
