package cn.onebound.sdk.merchant_data.jingcheng.api;
...
public class JingchengItemApi extends BaseApi {
    
    public JingchengItemApi(ClientConfig config) {
        super(config, "jingcheng");
    }
