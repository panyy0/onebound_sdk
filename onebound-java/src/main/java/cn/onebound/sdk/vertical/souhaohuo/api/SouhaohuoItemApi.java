package cn.onebound.sdk.vertical.souhaohuo.api;
...
public class SouhaohuoItemApi extends BaseApi {
    
    public SouhaohuoItemApi(ClientConfig config) {
        super(config, "souhaohuo");
    }
