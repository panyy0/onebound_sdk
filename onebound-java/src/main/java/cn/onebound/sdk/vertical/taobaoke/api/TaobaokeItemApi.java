package cn.onebound.sdk.vertical.taobaoke.api;
...
public class TaobaokeItemApi extends BaseApi {
    
    public TaobaokeItemApi(ClientConfig config) {
        super(config, "taobaoke");
    }
