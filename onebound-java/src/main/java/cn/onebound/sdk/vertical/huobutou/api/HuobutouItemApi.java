package cn.onebound.sdk.vertical.huobutou.api;
...
public class HuobutouItemApi extends BaseApi {
    
    public HuobutouItemApi(ClientConfig config) {
        super(config, "huobutou");
    }
