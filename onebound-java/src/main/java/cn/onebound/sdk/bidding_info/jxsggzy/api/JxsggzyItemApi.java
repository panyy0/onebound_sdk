package cn.onebound.sdk.bidding_info.jxsggzy.api;
...
public class JxsggzyItemApi extends BaseApi {
    
    public JxsggzyItemApi(ClientConfig config) {
        super(config, "jxsggzy");
    }
